...
for key in data:
    try:
        tmpData[key]['desc'].append(tmpData[key]['higher_level'])
...
newData = { key : { "name": tmpData[key]['name'], "desc":tmpData[key]['desc'], "range": tmpData[key]['range'], 'components': tmpData[key]['components'],
